...
const part1TestInput = [
    {
        example: "1-3 a: abcde",
        valid: true,
        expectedPolicy: {min: 1, max: 3, character: 'a'}
    },
    {
        example: "1-3 b: cdefg",
        valid: false,
        expectedPolicy: {min: 1, max: 3, character: 'b'}
    },
    {
        example: "2-9 c: ccccccccc",
        valid: true,
        expectedPolicy: {min: 2, max: 9, character: 'c'}
    },
]
...
function countChar(pattern, char) {
    return (pattern.match(new RegExp(char, "g")) || []).length
}
...
testCountChar('asdf', 'a', 1)
testCountChar('asdaf', 'a', 2)
